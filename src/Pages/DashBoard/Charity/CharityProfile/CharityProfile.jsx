...
const CharityProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-16 bg-primary shadow-2xl rounded-2xl overflow-hidden border border-gray-200">
      {/* Header */}
      ...
      <div className="p-6">
        ...
        <p className="text-secondary text-sm leading-relaxed">{mission}</p>
      </div>
    </div>
  );
};
